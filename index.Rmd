...
![](./imagenes/logos/portada.png){width=340 height=400}
...
coche1950 <- image_read("./imagenes/coches/1950.jpg") %>% image_scale(., "500") %>%  image_annotate(., "1950", size = 60, gravity = "southwest", color = "cyan", boxcolor = "gray13")
coche1960 <- image_read("./imagenes/coches/1960.jpg") %>% image_scale(., "500")%>%  image_annotate(., "1960", size = 60, gravity = "southwest", color = "cyan", boxcolor = "gray13")
coche1970 <- image_read("./imagenes/coches/1970.jpg") %>% image_scale(., "500")%>%  image_annotate(., "1970", size = 60, gravity = "southwest", color = "cyan", boxcolor = "gray13")
coche1980 <- image_read("./imagenes/coches/1980.jpg") %>% image_scale(., "500")%>%  image_annotate(., "1980", size = 60, gravity = "southwest", color = "cyan", boxcolor = "gray13")
coche1990 <- image_read("./imagenes/coches/1990.jpg") %>% image_scale(., "500")%>%  image_annotate(., "1990", size = 60, gravity = "southwest", color = "cyan", boxcolor = "gray13")
coche2005 <- image_read("./imagenes/coches/2005.jpg") %>% image_scale(., "500")%>%  image_annotate(., "2005", size = 60, gravity = "southwest", color = "cyan", boxcolor = "gray13")
coche2020 <- image_read("./imagenes/coches/2020.jpg") %>% image_scale(., "500")%>%  image_annotate(., "2020", size = 60, gravity = "southwest", color = "cyan", boxcolor = "gray13")
...
Las grandes mejoras en seguridad han supuesto un enorme descenso en los accidentes mortales
...
<div class='right' style='float:right;width:29%'>

Muy marcado el paso a las televisiones de pago y la retirada momentánea de Alonso.
...
#### Años anteriores con enorme desigualdad presupuestaria. --> 

#### Pocas escuderías en la lucha por el título             -->

</div>

<div class='right' style='float:right;width:40%'>

#### Reunificación de presupuestos

#### Se esperan muchos candidatos al título
...
Sólo unos cuántos afortunados han sido capaces de salir últimos y acabar en el podium
...
![](./imagenes/CAMPEON/campeon_verstappen.jpg){width=400 height=625}
...
Uno de los finales más apasionantes en la historia de la Formula 1
...
Empatados a puntos en la última carrera
...
Ubicación, número, nombre y país de cada circuito
